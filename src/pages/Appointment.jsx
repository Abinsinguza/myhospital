  ...
  return (
    ...
    <div className="relative">
      ...
      <div className="w-full flex items-center  h-screen">
        <div className="rounded-2xl bg-white/80  w-full justify-center w- h-9/12 max-w-screen-x1 shadow-[0_25px_50px_-6px_rgba(59,130,246,0.5)] p-10">
          {!isBooked ? (
            ...
            <option>Maternity</option>
              ...
              <div className="flex justify-end mt-6">
                <button
                  ...
                  className="bg-green-700 text-white px-6 py-3 rounded-lg shadow hover:bg-green-600 focus:outline-none focus:ring-2 focus:ring-green-500"
                >
                  Book Appointment
                </button>
              </div>
            ...
            <div className="appointment-booked">
              <div className=" text-center py-10">
                <h2 className="text-3xl font-bold mb-4 mt-36">
                  Your Appionment has been successfully booked!
                </h2>
                ...
                <p className="text-gray-900 text-lg font-thin mb-2">
                  A confirmation SMS will be sent to your phone number (+256
                  777-000-000) by our staf to confirm your appointment.
                </p>

                <p className="text-blue-500 font-semibold">
                  Thank you for choosing CityCare General Hospital.
                </p>
              ...
              <button
                ...
                type="button"
                class="  text-green-700 hover:text-white border border-green-700 hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-lg text-xl px-20 py-2.5 text-center me-2 mb-2 dark:border-green-500 dark:text-green-500 dark:hover:text-white dark:hover:bg-green-600 dark:focus:ring-green-800"
              >
                Back to Home
              </button>
              </div>
